...
public class PlaceServiceImpl implements PlaceService {
    ...
    @Override
    public List<PlaceDTO> getPlacesByAttributes(String name,String address,Boolean match,PageRequest pageRequest) {
    ...
    public PlaceDTO addPlaceToFavorites(Long id) throws ContentNotFoundException {
        Long userId = authService.getCurrentUserId();
        /// FIXME: Throw authorized exception
    ...
    public boolean insertImagesByPlaceId(Long placeId, MultipartFile[] files) {
        ...
        List<String> placeImageUrls = place.getImageUrls();
        placeImageUrls.addAll(imageService.uploadImages(files, ImagePath.PLACE));
    ...
    private ExampleMatcher getExampleMatcher(Boolean match) {
        ExampleMatcher matches = ExampleMatcher.matchingAll()
                ...
                .withIgnorePaths("id","description","imageUrl","linkUrl","region","placeType","placeCategory");
