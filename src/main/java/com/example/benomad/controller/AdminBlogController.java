...
public class AdminBlogController {
    ...
    @Operation(summary = "Approves blog by ID")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "OK",
    ...
    @PutMapping(value = "/{blogId}/approve")
    public ResponseEntity<?> approveBlogById(@PathVariable Long blogId){
        return ResponseEntity.ok(blogService.approveBlog(blogId));
    }

    @Operation(summary = "Rejects blog by ID")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "OK",
    ...
    @PutMapping(value = "/{blogId}/reject")
