...
create table users (id  bigserial not null, registration_date date, email varchar(255) not null, first_name varchar(255) not null, is_activated boolean, is_deleted boolean not null, last_name varchar(255) not null, last_visit_date date, password varchar(255) not null, phone_number varchar(255), deletion_info_id int8, primary key (id));
