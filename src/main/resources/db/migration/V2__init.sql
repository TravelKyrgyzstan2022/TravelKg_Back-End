create table articles (id  bigserial not null, body varchar(10000) not null, image_url varchar(255), title varchar(500) not null, user_id int8, primary key (id));
...
create table blogs (id  bigserial not null, body varchar(10000) not null, creation_date date, image_url varchar(255), is_deleted boolean not null, review_status varchar(255), title varchar(500) not null, update_date date, author_id int8, deletion_info_id int8, primary key (id));
...
create table places (id  bigserial not null, address varchar(255), description varchar(2000) not null, image_url varchar(255) not null, link_url varchar(255) not null, name varchar(255) not null, place_category varchar(255), place_type varchar(255), region varchar(255), primary key (id));
