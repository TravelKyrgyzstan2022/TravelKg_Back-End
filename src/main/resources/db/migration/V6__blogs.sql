...
INSERT INTO blogs (is_deleted, id, author_id, title, body, review_status, creation_date)
VALUES (false, nextval('blogs_id_seq'), 6, 'Hiking to Jiptick Pass (4185m) in the Alay Mountains of Kyrgyzstan. 🏞️🏔️',
